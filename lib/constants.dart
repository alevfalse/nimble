...
const kPrimaryDarkColor = Color(0xFFdf2e6d);
const kPrimaryColor = Color(0xFFef6797);
const kPrimaryLightColor = Color(0xFFff71a3);
const kAccentColor = Colors.blue;
const kAccentLightColor = Colors.lightBlueAccent;
...
const kTextFieldDecoration = InputDecoration(
  ...
  enabledBorder: OutlineInputBorder(
    borderSide: BorderSide(color: kPrimaryLightColor, width: 1.0),
    borderRadius: BorderRadius.all(Radius.circular(32.0)),
  ),
